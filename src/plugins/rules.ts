export const inputRulesPlugin = {
  install: (Vue: any) => {
    Vue.prototype.$rules = {
      ...
      equal: (target: string, msg: string) => (v: string) =>
      ...
      nospace: (v: string) =>
        !v || !/ /.test(v.trim()) || "Space is not allowed",
